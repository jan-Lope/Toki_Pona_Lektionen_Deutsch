...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Das (zusammengesetzte) Substantiv eines Präpositional-Objektes nach der Präposition \textit{lon} kann vor \textit{la} mit (fast) gleicher Bedeutung plaziert werden. 
Dies gilt nur, wenn der Satz nur eine Prädikat-Phrase mit nur einem Präpositional-Objekt enthält. 
