...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsection*{Konditional-Phrasen versus Präpositional-Objekte mit \textit{lon} }
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Das (zusammengesetzte) Substantiv eines Präpositional-Objektes nach der Präposition \textit{lon} oder das (zusammengesetzte) Substantiv eines indirekten Objektes nach dem intransitiven Verb \textit{lon} kann in einigen Fällen vor \textit{la} mit fast gleicher Bedeutung plaziert werden. 
...
Man kann längst nicht alle möglichen \textit{la} Phrasen hinter der Präposition \textit{lon} oder dem intransitiven Verb \textit{lon} verschieben. 
...
Ein kompletter Satz kann jedoch nicht als Präpositionsobjekt oder indirekten Objekt verwendet werden.
