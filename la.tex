...
la && Ein \glqq la\grqq  trennt eine Phrase von einem Satz. \\
mun && Mond, Mond-  \\
...
Eine \textit{la}-Phrase kann aus einem zusammengesetzten Substantiv bzw. Pronoun betehen. Da heißt, nach dem Substantiv bzw. Pronoun folgen ein oder mehrere Adjektive bzw. \textit{pi}-Phrasen. 
Optional kann vor dem Substantiv bzw. Pronoun ein Konjunktion (\textit{anu}, \textit{en}, \textit{taso}) sein. 
