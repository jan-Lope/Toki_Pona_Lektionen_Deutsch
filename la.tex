...
%
\index{ike!la}
\textbf{ike la \dots} && \textit{Substantiv}: bei Verderbtheit, bei Boshaftigkeit \\  % no-dictionary
 && \\ % no-dictionary
%
\index{ken!la}
...
%
\index{pona!la}
\textbf{pona la \dots} && \textit{Substantiv}: zum Glück, wenn Einfachheit \\  % no-dictionary
 && \\ % no-dictionary
...
Im der deutschen Sprache wird eine Bedingung mit Hilfe die Wörter 'wenn', 'falls' und 'sofern' gebildet.
...
Gibt es also nur ein Wort-Slot vor \textit{la} kann es nur mit einem Substantiv oder Pronoun gefüllt werden. 
...
\begin{supertabular}{p{5,5cm}|ll}
taso ni la mi pilin pona. && Nur bei diesem fühle ich mich gut. \\
\end{supertabular} 
...
Da heißt, nach dem Substantiv bzw. Pronomen folgen ein oder mehrere Adjektive bzw. \textit{pi}-Phrasen. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsection*{Das Fragepronomen \textit{seme} in der Konditional-Phrase}
%
...
Wir das Fragepronomen \textit{seme} in der Konditional-Phrase verwendet, bedeutet dies 'Unter welchen Bedingungen ist ... wahr?'
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsection*{Konditional-Phrasen versus Präpositional-Objekts nach der Päposition \textit{lon} }
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
Es kann keines der Präpositional-Objekte nach vor dem Separator \textit{la} verschoben werden, ohne die Aussage zu ändern. 
...
Ist dagegen das Prädikat bei allen Prädikat-Phrasen identisch, können Prepositional-Objekte mit \textit{lon} vor \textit{la} verschoben werden.

\begin{supertabular}{p{5,5cm}|ll}
ona li moku, lon tenpo ni li moku, lon tenpo kama. && Er ißt jetzt und er ißt später. \\
tenpo ni la tenpo kama la ona li moku. && Jetz und später ißt er. \\
tenpo ni en tenpo kama la ona li moku. && Jetz und später ißt er. \\
\end{supertabular}
...
Da das Prädikat (\textit{lon}) ein beiden Prädikat-Phrasen gleich ist, können die indirekten Objekte vor \textit{la} verschoben werden. 
...
poka sina la mi tawa.    && Wenn an deiner Seite gehe ich. / Ich gehe an deiner Seite.  \\
\end{supertabular} 
