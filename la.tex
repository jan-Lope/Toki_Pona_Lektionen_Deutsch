...
Es wird mit der \textit{la}-Phrase begonnen. Nach \textit{la} beginnt der
Hauptsatz.
Leider gibt es keine logische Erklärung warum \textit{ken la} 'vielleicht' bedeutet. 
Man muß es einfach so hinnehmen.
