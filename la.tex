...
Eine \textit{la}-Phrase kann aus einem einzelnen Wort bestehen. Dieses einzelne Wort kann nur ein Substantiv bzw. Pronomen sein.
Eine \textit{la}-Phrase kann aus einem zusammengesetzten Substantiv bzw. Pronomen betehen. Da heißt, nach dem Substantiv bzw. Pronomen folgen ein oder mehrere Adjektive bzw. \textit{pi}-Phrasen. 
Optional kann vor dem Substantiv bzw. Pronomen eine Konjunktion (\textit{anu}, \textit{en}, \textit{taso}) sein. 
...
Das Präpositional-Objekt nach der Präposition \textbf{lon} kann vor \textbf{la} mit der gleichen Bedeutung platziert werden.
...
tawa mi \textbf{la} mi pilin pona. && Bin ich in Bewegung, ich fühle mich gut. \\
tan ni \textbf{la} mi sona e nasin. && Wenn dies die Ursache ist, wissen wir die Lösung. \\

lon ona \textbf{la} mi ken lukin e ona. && Hat es ein Sein, können wir es auch sehen. \\
