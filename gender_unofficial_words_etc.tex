...
\textbf{mije} && \textit{Substantiv}: Mann, Kerl, Ehemann, Liebhaber \\ % no-dictionary
 && \\ % no-dictionary
...
\textbf{nimi (e \dots) } && \textit{Verb, transitiv}: bennenen, Namen geben \\ % no-dictionary
 && \\ % no-dictionary
\textbf{o!} && \textit{Interjektion}: Hallo! (um jemandes Aufmerksamkeit zu erwirken) \\ % no-dictionary
...
\textbf{ike!} && \textit{Interjektion}: Mist! Leider! Sch \dots ! \\ % no-dictionary
 && \\ % no-dictionary
\textbf{jaki!} && \textit{Interjektion}: Igit! Ekelhaft! \\ % no-dictionary
 && \\ % no-dictionary
