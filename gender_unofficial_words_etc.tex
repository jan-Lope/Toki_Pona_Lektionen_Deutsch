...
Entweder wird das inoffizielles Wort direkt nach dem Substantiv oder als Prädikatsadjektiv nach \textit{li} verwendet. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Interjektionen (Ausrufe) bestehen oft nur aus einem Substantiv oder einem Interjektion-Word (z.B: \textit{a}) und enden mit einem Ausrufungszeichen.
