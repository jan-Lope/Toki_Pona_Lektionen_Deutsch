...
Das Fragepronomen \textit{seme} ersetzte den Satzteil nach dem gefragt wird. 
Je nachdem in welchen Slot \textit{seme} verwendet wird, kann es unterschiedliche Wortarten vertreten. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Wird mit dem Fragepronomen \textit{seme} ein kompletter Satz bildet, hat man nichts verstanden. 
