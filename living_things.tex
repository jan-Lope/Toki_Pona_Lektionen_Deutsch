...
Das erste \textit{kala} im letzten Satz ist natürlich ein Substantiv. 
...
\begin{supertabular}{p{5,5cm}|ll}
kasi suli li kasi, tawa sewi. && Der Baum wächste in den Himmel. \\
\end{supertabular} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsection*{Tiergeräusche und -Kommunikation}
%
\index{Tiergeräusche}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Das Substantiv \textit{mu}}
\index{mu!Substantiv}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Das Adjektiv  \textit{mu}}
\index{mu!Adjektiv}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Das transitive Verb \textit{mu}}
\index{mu!Verb}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Das intransitive Verb \textit{mu}}
\index{mu!Verb}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Das Adverb \textit{mu}}
\index{mu!Adverb}
...
\begin{supertabular}{p{5,5cm}|ll}
Welches Trennzeichen steht am Ende einer Frage? &&  \\ % no-dictionary
In welchen Fällen wird ein Komma verwendet? &&  \\ % no-dictionary
In welchen Fällen wird ein Doppelpunkt verwendet? &&  \\ % no-dictionary
Wo sind mögliche Slots für Präpositions in einem Satz? &&  \\ % no-dictionary
\end{supertabular}
...
\begin{supertabular}{p{5,5cm}|ll}
Ist dies ein Säugetier? &&  \\ % & English - Toki Pona
