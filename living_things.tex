...
\textbf{kasi} && \textit{Substantiv}:  Pflanze, Blatt, Kraut, Baum, Strauch, Gras, Pilz \\ % no-dictionary
...
%
\index{moli} 
\textbf{\dots moli} && \textit{Adjektiv}: tot, tödlich, fatal, schwerwiegend \\ % no-dictionary
...
%
\index{monsuta}
\textbf{\dots monsuta} && \textit{Adjektiv} (inoffiziell): ängstlich \\ % no-dictionary
\textbf{monsuta} && \textit{Substantiv} (inoffiziell): Monster, Ungeheuer, Fabelwesen, Angst \\ % no-dictionary
 && \\ % no-dictionary
%
\index{namako}
...
\textbf{pan (e \dots)} && \textit{Verb, transitiv}: säen, aussäen \\ % no-dictionary
 && \\ % no-dictionary
%
\index{soweli}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Das transitive Verb \textit{pan} bedeutet 'säen' oder 'aussäen'.
...
Das Adjektiv \textit{moli} bedeutet 'tot', 'tödlich', 'fatal' oder 'schwerwiegend'. 
...
Wo sind mögliche Slots für Präpositionen in einem Satz? &&  \\ % no-dictionary
\end{supertabular}
