...
% In \textit{toki pona} werden 
% Ortsangaben mit speziellen Substantiven ...
% meist mit \textit{lon} als intransitivs Verb oder als Preposition.
% D.h. Ortsangaben befinden sich in indirekten Objekte oder Präpositionalobjekten.
% Ist kein Verb vorhanden, kann \textit{lon} keine Präposition sein. 
% Teil der Prädikatsphrase.
