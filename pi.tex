...
Der Separator \textit{pi} darf nicht mit dem Separator \textit{li} oder \textit{e} beisammen stehen.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Der Separator \textit{pi} wird auch verwendet, um Wörter mit dem Adjektiv \textit{ala} in ihr Gegenteil zu verwandeln.
...
Auch für Fragen nach Eigentumsverhältnissen wird der Separator \textit{pi} verwendet.
...
Es gibt keine verschachtelten \textit{pi}-Phrasen. 
...
\textit{kalama} wird oft mit dem Adjektiv \textit{musi} kombiniert.
...
\textit{kalama musi} steht vor den Namen von Liedern.
