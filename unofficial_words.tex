...
Ist es zum Beispiel ein Ländername, so wird das entsprechende Adjektiv nach dem Substantiv \textit{ma} verwendet. 
...
Es können inoffizielle Wörter an die phonetischen Regeln von \textit{toki pona} angepasst werden.
...
Im Anhang findet man eine Liste von wichtigen inoffiziellen Wörtern (siehe Seite \pageref{'unofficial_words'}). 
%
