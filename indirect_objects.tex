...
%
In diesen Beispielen wird das intransitives Verb \textit{lon} verwendet. 
...
%
Das intransitive Verb \textit{pakala} bedeutet 'vermasseln', 'auseinander fallen' oder 'brechend'.
...
Die Frau gebahr ihr Kind. &&   \\  % no-dictionary
\end{supertabular} 
