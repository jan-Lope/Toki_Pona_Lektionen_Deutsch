...
\textbf{mi} && \textit{Pronomen}: ich, mich, wir  \\ 
 && \\ % no-dictionary
...
\textbf{ni} && \textit{Pronomen}: dies, diese, dieser, dieses (hier), (das) dort, jenes \\ 
 && \\ % no-dictionary
...
\textbf{ona} && \textit{Pronomen}: er, sie, es, sie (Plural)  \\ 
 && \\ % no-dictionary
...
\textbf{sina} && \textit{Pronomen}: du, ihr (Plural), euch  \\ 
 && \\ % no-dictionary
