...
\textbf{kute (e \dots)} && \textit{transitives Verb}: hören, zuhören \\ 
 && \\ % no-dictionary
\textbf{\dots la \dots} && \textit{Separator}: Ein \glqq la\grqq  trennt eine Phrase (Satz, Halbsatz oder Substantiv) von einem Satz. \\  && Verwende ein \glqq la\grqq nicht zusammmen mit einem der anderen Sepratoren. \\ 
 && \\ % no-dictionary
