...
\textbf{kepeken \dots} && \textit{Präposition}: mit, mittels, per \\ 
...
\textbf{lon \dots} && \textit{Präposition}: in, im, an, am, bei, auf \\ 
...
% \textbf{poka \dots} && \textit{Präposition}:  in Gesellschaft von, mit, neben \\ 
 && \\ % no-dictionary
...
\textbf{sama \dots} && \textit{Präposition}: wie, dergleichen \\ 
...
\textbf{tan \dots} && \textit{Präposition}: von, aus, durch, wegen, weil, seit \\ 
...
\textbf{tawa \dots} && \textit{Präposition}: zu, um zu, zu hin, nach, für, bis, in \\ 
