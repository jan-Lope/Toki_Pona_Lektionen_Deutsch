...
\textbf{.} && \textit{Separator}: Beendet wird ein Aussagesatz mit einem Punkt. \\ && Verwende einen Punkt nicht zusammmen mit einem der anderen Separatoren. \\ 
 && \\ % no-dictionary
\textbf{!} && \textit{Separator}: Die Befehlsform und Interjektionen enden mit einem Ausrufungszeichen. \\ && Verwende ein Ausrufungszeichen nicht zusammmen mit einem der anderen Separatoren. \\ 
 && \\ % no-dictionary
\textbf{?} && \textit{Separator}: Beendet wird eine Frage mit einem Fragezeichen. \\ && Verwende ein Fragezeichen nicht zusammmen mit einem der anderen Separatoren. \\ 
 && \\ % no-dictionary
...
\textbf{kute (e \dots)} && \textit{Verb, transitiv}: hören, zuhören \\ 
 && \\ % no-dictionary
\textbf{\dots la \dots} && \textit{Separator}: Ein \glqq la\grqq  trennt eine Phrase (Satz, Halbsatz oder Substantiv) von einem Satz. \\  && Verwende ein \glqq la\grqq nicht zusammmen mit einem der anderen Separatoren. \\ 
 && \\ % no-dictionary
...
\textbf{meli} && \textit{Substantiv}: Frau, Dame, Lady, Mädchen, Weibchen, Weib, Ehefrau, Freundin \\ 
 && \\ % no-dictionary
\textbf{\dots mi} && \textit{Adjektiv}: mein, unser \\  
\textbf{mi} && \textit{Pronoun}: ich, mich, wir  \\ 
 && \\ % no-dictionary
...
\textbf{nena} && \textit{Substantiv}: Beule, Hügel, Berg, Gebirge, Erhebung, Button, Nase, Rundung \\ 
 && \\ % no-dictionary
\textbf{\dots ni} && \textit{Adjektiv}: dies, diese, dieser, dieses (hier), (das) dort, jenes \\  
\textbf{ni} && \textit{Pronoun}: dies, diese, dieser, dieses (hier), (das) dort, jenes \\ 
 && \\ % no-dictionary
...
\textbf{olin (e \dots)} && \textit{Verb, transitiv}: (eine Person) lieben \\ 
 && \\ % no-dictionary
\textbf{\dots ona} && \textit{Adjektiv}: seins, ihres, seine, deren \\  
\textbf{ona} && \textit{Pronoun}: er, sie, es, sie (Plural)  \\ 
 && \\ % no-dictionary
...
\textbf{sin (e \dots)} && \textit{Verb, transitiv}: erneuern, renovieren, auffrischen, beleben \\ 
 && \\ % no-dictionary
\textbf{\dots sina} && \textit{Adjektiv}: deins, euer  \\  
\textbf{sina} && \textit{Pronoun}: du, ihr (Plural), euch  \\ 
 && \\ % no-dictionary
