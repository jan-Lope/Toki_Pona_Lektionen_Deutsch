...
Wann werden offizielle \textit{toki pona} Wörter groß geschrieben? && Niemals. \\ % no-dictionary
...
jan - mi ' jan.  && Adjektiv, Substantiv \\ % no-dictionary
\end{supertabular} 
...
jaki li jaki lili e mi. && Der Müll beschmutzt mich ein wenig. \\ % & English - Toki Pona
sina len nasa jaki e sina. && Du kleidest dich ekelhaft albern. \\ % & English - Toki Pona
ilo li sewi e sewi. && Die Maschine hebt das Dach hoch. \\ % & English - Toki Pona
...
\begin{supertabular}{p{5,5cm}|ll}
Wie bildet man relative Ortsangaben in \textit{toki pona}? && Mit einem indirekten Verb/Präposition + ortsbezogenen Substantiv. \\ % no-dictionary
...
Welcher Separator steht am Ende eines Aussagesatzes? && Ein Punkt. \\ % no-dictionary
Was ist ein Prädikatsadjektiv? && Ein Adjektiv, das als Prädikat verwendet wird. \\ % no-dictionary
...
Wie antwortet man in \textit{toki pona} negativ auf eine Ja/Nein-Frage? && Man wiederholt das Prädikat bzw. Hilsverb der Frage und fügt \textit{ala} an. \\ % no-dictionary
Wie antwortet man in \textit{toki pona} positiv auf eine Ja/Nein-Frage? && Man wiederholt das Prädikat bzw. Hilsverb der Frage. \\ % no-dictionary
\end{supertabular}
...
Was kann das Wort \textit{seme} vertreten? && Satzteile bzw. alle Wortarten (außer Separatoren).  \\ % no-dictionary
...
Dies ist meins. && mi jo e ni. \\ % & English - Toki Pona
\end{supertabular}  
...
Wie wird in \textit{toki pona} eine Antwortfrage gebildet? && Die Konjunktion \textit{anu} und das Fragepronomen \textit{seme} wird angefügt. \\ % no-dictionary
...
\begin{supertabular}{p{5,5cm}|ll}
Der Slot nach der Konjunktion \textit{en} kann welche Wortart(en) beinhalten? && Substantiv oder Pronomen.  \\ % no-dictionary
...
Der Slot nach dem Separator \textit{pi} kann welche Wortart(en) beinhalten? && Substantiv oder Pronomen.  \\ % no-dictionary
...
In welchen Fällen wird ein Doppelpunkt verwendet? && Ein Doppelpunkt trennt einen Hinweissatz von und einem Satz. \\ % no-dictionary
