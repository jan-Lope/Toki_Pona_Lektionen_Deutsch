...
\begin{supertabular}{p{5,5cm}|ll}
Wie bildet man relative Ortsangaben in \textit{toki pona}? && Indirekten Verb/Präpositio + zusammengesetztes ortsbezogenen Substantiv. \\ % no-dictionary
Was ist ein Possessivpronomen? && Ein Possessivpronomen drückt eine Eigenschaft oder Zugehörigkeit aus.  \\ % no-dictionary
...
Wie wird in \textit{toki pona} eine Ja/Nein-Frage formuliert? && Es wird das Adverb \textit{ala} an das (Hilfs-)Verb angefügt und das (Hilfs-)Verb wiederholt.  \\ % no-dictionary
...
Wie antwortet man in \textit{toki pona} negativ auf eine Ja/Nein-Frage? && Man wiederholt das (Hilfs-)Verb der Frage und fügt das Adverb \textit{ala} an. \\ % no-dictionary
Wie antwortet man in \textit{toki pona} positiv auf eine Ja/Nein-Frage? && Man wiederholt das (Hilfs-)Verb der Frage. \\ % no-dictionary
\end{supertabular}
