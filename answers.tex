...
Was ist ein Pronom? && Ein Pronom ist ein Stellvertreter für ein Substantiv. \\ % no-dictionary
...
Wann kann ein Verb-Slot leer sein? && Wenn das Prädikat durch ein Substantiv (Prädikatsnomen) oder Adjektiv (Prädikatsadjektiv) gebildet wird.  \\  % no-dictionary
Was ist ein Prädikat? && Es ist ein Kernbestandteil in einem Satz und es ist die Ausage des Satzes. \\  % no-dictionary
...
Wo befinden sich mögliche Adjektiv-Slots? && Nach einem Substantiv, nach einem einem Pronomen und nach \textit{li} (Prädikatsadjektiv).  \\  % no-dictionary
