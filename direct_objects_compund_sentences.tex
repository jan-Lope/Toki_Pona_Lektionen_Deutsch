...
Das Demonstrativpronomen (hinweisendes Fürwort) ist eine Wortart, mit der der Sprecher auf einen Gesprächsgegenstand verweist. 
...
Ein substantivisches Demonstrativpronomen wird anstatt des Substantivs verwendet. 
...
\subsubsection*{Mehrere \textit{li} Separatoren}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Mehrere \textit{li} werden bei mehreren Handlungen verwendet.

\begin{supertabular}{p{5,5cm}|ll}
ona li lukin li unpa. && Er schaut und hat Sex. \\
\end{supertabular} 

Indem man \textit{li} vor jedes Verb stellt, kann man zeigen, wie das Subjekt, das in diesem Fall \textit{ona} ist, mehr als eine Sache macht. 
Jedes \textit{li} beginnt eine neue Prädikat-Phrase. 
...
Das offizielle Toki Pona Buch empfiehlt bei \textit{mi} oder \textit{sina} als Subjekt nur eine Prädikat-Phrase zu verwenden. 

%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{'multiple_e'}
\subsubsection*{Mehrere \textit{e} Separatoren}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Wenn sich eine Handlung, also ein Verb auf mehrere direkte Objekte bezieht, dann werden mehrere \textit{e} verwendet.  
In diesem Fall gehören alle direkten Objetkte zu einer Prädikat-Phrase. 
