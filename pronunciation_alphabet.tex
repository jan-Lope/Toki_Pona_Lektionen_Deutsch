...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\textit{toki pona} hat 14 Buchstaben: 
...
Zum Beispiel trennt ein Punkt einen Satz vom nächsten Satz. 
...
Fragesätze (Interrogativsätze) formulieren eine Frage. 
Sie enden mit einem Fragezeichen. 

Aufforderungssätze (Imperativsätze) sind Sätze, die einen Befehl formulieren. 
Sie enden mit einem Ausrufungszeichen. 

Ausrufesätze (Exklamativsätze) sind Sätze, die Bewunderung oder Verwunderung zum Ausdruck bringen. 
...
Welcher Separator steht am Ende eines Aussagesatzes? && \\ % no-dictionary
 && \\ % no-dictionary
Wann werden die offiziellen \textit{toki pona}-Wörter groß geschrieben? && \\ % no-dictionary
 && \\ % no-dictionary
