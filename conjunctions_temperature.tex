...
%
\index{kin}
\textbf{\dots kin} && \textit{Adjektiv}: auch, noch, ebenso, ferner, außerdem, gerade, wirklich, tatsächlich \\ && kin kann das letzte Wort in einer Adjektiv-Gruppe sein. \\ % no-dictionary
...
%
\index{pilin}
\textbf{\dots pilin} && \textit{Adjektiv}: sensitiv, fühlend, empathisch \\ % no-dictionary
...
%
\index{taso}
\textbf{\dots taso} && \textit{Adjektiv}: nur, einzig, alleinig \\ % no-dictionary
\textbf{\dots taso} && \textit{Adverb}: nur, einzig, alleinig \\ % no-dictionary
...
% in \textit{toki pona} gibt es keine Fälle, da es keine Deklination gibt!
...
Da es in \textit{toki pona} das Verb 'sein' nicht gibt, kann das Verb-Slot leer bleiben. 
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Eine Konjunktion am Satzanfang}

Wie wir gerade gelernt haben, kann die Konfunktion \textit{taso} am Anfang eines Satzes stehen. 
Es ist also ein Slot für eine Konjunktion am Anfang eines Satzes möglich. 
Eine solche Konjunktion verbindet keine Hauptsätze.
Sonst würde ja kein Punkt den Satz davor beenden.
Mit einer solchen Konjunktion bezieht der Satz sich auf den vorherigen Satz. 
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Das Adjektiv \textit{taso}}
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Das Adverb \textit{taso}}
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Das Substantiv \textit{kin}}
%
\index{\textit{kin}!Substantiv}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Das Adjektiv \textit{kin}}
%
\index{\textit{kin}!Adjektiv}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Das Adjektiv \textit{kin} steht am Ende einer Adjektiv-Gruppe und betont diese.
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Das Adverb \textit{kin}}
%
\index{\textit{kin}!Adverb}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Das Adverb \textit{kin} steht am Ende einer Adverb-Gruppe.
...
Wenn man die Temperatur eines Gegenstandes beschreiben will, verwendet man \textit{seli} oder \textit{lete} als Prädikatsnomen. 
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Das intransitive Verb \textit{pilin}}
%
\index{\textit{pilin}!verb}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Wenn man friert oder schwitzt sagt man dies mit dem intransitiven Verb \textit{pilin} und den Adverbien \textit{seli} or \textit{lete}.

\begin{supertabular}{p{5,5cm}|ll}
mi pilin lete mute. && Mir ist sehr kalt. \\
\end{supertabular}

Mit dem intransitiven Verb \textit{pilin} lassen sich allgemein Gefühle einer Person oder eines Tieres beschreiben. 
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Das transitive Verb \textit{pilin}}
%
\index{\textit{pilin}!verb}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Das transitive Verb \textit{pilin} bedeutet 'denken'.
