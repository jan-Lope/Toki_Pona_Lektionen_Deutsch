...
Da es sowohl die Präposition \textit{lon} auch das intransitives Verb \textit{lon} gibt, ist möglicherweise die Aussage folgender Sätze verwirrend.
...
\textit{toki pona} kennt keine verschachtelte Nebensätze.
...
Nach 'mi pana e tomo' ist sowohl ein Slot für ein Adjektiv als auch ein Slot für eine Präposition möglich. 
Mit dem Adjektiv \textit{tawa} bedeutet der Satz 'Ich gebe dein Auto'. 
Mit der Präposition \textit{tawa} bedeuten dagegen der Satz 'Ich gebe dir das Haus'. 
Man kann ein Komma vor \textit{tawa} einfügen, um nur einen Slot für Preposition zu erzwingen. 
...
%
In diesm Satz wird das intransitives Verb \textit{kama} und die Präposition \textit{tawa} verwendet.
...
Wenn man allerdings unbedingt dieses Werkzeug verwenden möchte, muß man das intransitive Verb \textit{kepeken} verwenden. 
...
%
In anderen Lektionen wird das intransitives Verb \textit{tawa} verwendet.
