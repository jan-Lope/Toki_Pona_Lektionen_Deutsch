...
%
\index{sitelen}
\textbf{\dots sitelen} && \textit{Adjektiv}: bildlich, figurativ, bildhaft, metaphorisch \\ % no-dictionary
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Das transitive Verb \textit{kule}}
%
\index{\textit{kule}!Verb}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Das transitive Verb \textit{kule} bedeutet  'färben'. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Das Adjektiv \textit{sitelen}  bedeutet  'bildlich', 'figurativ', 'bildhaft', 'metaphorisch' oder '(auf)geschriebene'.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsection*{Das transitive Verb \textit{sitelen}}
%
\index{\textit{sitelen}!Verb}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Das transitive Verb \textit{sitelen} bedeutet 'malen' oder 'schreiben'.
...
\begin{supertabular}{p{5,5cm}|ll}
Der Slot nach der Konjunktion \textit{en} kann welche Wortart(en) beinhalten? &&   \\ % no-dictionary
...
Der Slot nach dem Separator \textit{pi} kann welche Wortart(en) beinhalten? &&   \\ % no-dictionary
...
Sieh diesen roten Käfer.  &&  \\ % no-dictionary
