...
Man kann auch Farben aus mehr als zwei Wörtern mischen.
...
\index{was!für eine Farbe}
\index{Farbe!was für eine}
...
\begin{supertabular}{p{5,5cm}|ll}
ni li ' \textbf{kule seme?} && Was ist dies für eine Farbe? \\
\end{supertabular} 
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Übungen 13 (Antworten siehe ~\pageref{'colors'})}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\begin{supertabular}{p{5,5cm}|ll}
