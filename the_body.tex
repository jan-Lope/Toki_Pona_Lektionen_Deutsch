...
%
\index{linja}
\textbf{\dots linja} && \textit{Adjektiv}: länglich, rechteckig, lang \\ % no-dictionary
...
%
\index{nena}
\textbf{\dots nena} && \textit{Adjektiv}: hügelig, bergig, bucklig, holprig \\  % no-dictionary
\textbf{nena} && \textit{Substantiv}: Beule, Hügel, Berg, Gebirge, Erhebung, Button, Nase, Rundung \\  % no-dictionary
 && \\ % no-dictionary
%
\index{oko}
\textbf{\dots oko} && \textit{Adjektiv}: optisch, Augen- \\  % no-dictionary
...
\textbf{palisa (e \dots)} && \textit{Verb, transitiv}: strecken, sexuell erregen \\  % no-dictionary
 && \\ % no-dictionary
%
\index{selo}
...
%
\index{sijelo}
\textbf{\dots sijelo} && \textit{Adjektiv}:  körperlich, materiell, fleischlich \\  % no-dictionary
...
\textsc{**} Dieser Satz ist auch ein bisschen idiomatisch. 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% eof
