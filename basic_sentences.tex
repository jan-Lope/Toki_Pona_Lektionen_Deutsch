...
%
\index{Apostroph}
\textbf{'} && \textit{inoffiziell}: Ein leerer Verb-Slot wird hier zur Verdeutlichung mit einem Apostroph gekennzeichnet. \\ % no-dictionary
\end{supertabular} \\
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\textit{toki pona} kennt keine verschachtelte Nebensätze und fast keine Kommas.
