...
%
\index{jan}
\textbf{\dots jan} && \textit{Adjektiv}: persönlich, human, jemandes \\ % no-dictionary
\textbf{\dots jan} && \textit{Adverb}: persönlich, human, jemandes \\ % no-dictionary
...
%
\index{mi}
\textbf{mi} && \textit{Personalpronomen}: ich, wir  \\ % no-dictionary
\textbf{\dots mi} && \textit{Possessivpronomen}: mein, unser \\  % no-dictionary
\textbf{\dots e mi} && \textit{Reflexivpronomen}: mich, uns  \\ % no-dictionary
 && \\ % no-dictionary
%
\index{moku}
...
\textbf{\dots e sina} && \textit{Reflexivpronomen}: dich, euch  \\  % no-dictionary
 && \\ % no-dictionary
%
\index{suno}
...
%
\index{Apostroph}
\textbf{'} && \textit{inoffiziell}: Ein Apostroph kann ein Prädikat, das kein Verb enthält, kennzeichnen. \\ % no-dictionary
\end{supertabular} \\
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
Ohne Prädikat ist kein Aussagesatz möglich. 
...
%
Eine der ersten Prinzipien ist, dass es das statische Verb 'sein' nicht gibt. 
...
Man nennt diese Sprachen No-Copula-Sprachen. 
Eine Copula ist ein Wort, das Subjekt und Prädikat verbindet ('kopuliert').
Wenn ein 'normales' Verb das Prädikat bildet, braucht man keine zusätzliche Copula.
Sie tritt nur auf, wenn ein Substantiv, Pronomen oder Adjektiv das Prädikat bildet.
Im Deutschen dient das Verb 'sein' als Copula. 
No-Copula-Sprache, wie Toki Pona, benötigen keine Copula. 
...
In diesen Lektionen wird mit einem Apostroph ein nachfolgendes Substantiv beziehungsweise Adjektiv gekennzeichnet. 
...
\textit{li} ist ein grammatikalisches Wort, das die Subjekt-Phrase von der Prädikat-Phrase trennt. 
