...
In dieser Lektion werden wir uns mit Substantiven, Pronomen, Verben und einem speziellen Separator beschäftigen. 
...
Da damit der Verb-Slot unbelegt sein kann, kann nach \textit{mi} oder \textit{sina} auch ein Substantiv oder Adjektiv folgen. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Für Sätze, die nicht die Pronomen \textit{mi} oder \textit{sina} als Subjekt verwenden, gibt es das Wort \textit{li}. 
\textit{li} ist ein grammatikalisches Wort, daß ein Subjekt von seinem Verb trennt. 
Der Separator \textit{li} wird nur benutzt, wenn das Subjekt nicht \textit{mi} oder \textit{sina} ist. 
...
Da es das Verb 'sein' nicht gibt, kann auch nach \textit{li} nicht nur ein Verb , sondern auch ein Substantiv folgen. 
Diese Substantiv ist hier ein Objekt. 
 
Das fehlende Verb 'sein' wird hier zur Verdeutlichung wieder mit einem Apostroph gekennzeichnet (inoffiziell).
%
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
