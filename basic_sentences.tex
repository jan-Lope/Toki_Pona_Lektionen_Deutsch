...
Das fehlende Verb 'sein' wird in diesen Lektionen mit einem Apostroph gekennzeichnet. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Für Sätze, die nicht \textit{mi} oder \textit{sina} als Subjekt verwenden, gibt es das Wort \textit{li}. 
