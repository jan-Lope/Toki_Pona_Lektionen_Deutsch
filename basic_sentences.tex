...
%
\index{li}
\textbf{\dots li \dots} && \textit{Separator}: Er trennt die Subjekt-Phrase, außer \glqq mi\grqq und \glqq sina\grqqvon, von der Prädikat-Phrase. \\ % && Verwende ein \glqq li\grqq nicht zusammmen mit einem anderen Separator. \\  % no-dictionary
 && \\ % no-dictionary
%
\index{mi}
